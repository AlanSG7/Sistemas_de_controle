...
Na pasta "Modelagem e Identificação de Sistemas", há a explicação da construção de um modelo didático e eletrônico subamortecido. O circuito é utilizado para a confecção das práticas e algoritmos previamente citados.

Na pasta "Controle Fuzzy", há o desenvolvimento de um algoritmo de controle fuzzy para o sistema citado previamente, o qual é testado e utilizado com o auxílio do software MATLAB.
